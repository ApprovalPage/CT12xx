...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/CT12xx_Find_300x250_atlas_NP_.jpg", id:"CT12xx_Find_300x250_atlas_NP_"}
	]
};
...
lib.ssMetadata = [
		{name:"CT12xx_Find_300x250_atlas_NP_", frames: [[0,252,300,250],[0,0,300,250]]}
];
...
(lib.EndFrameblkfind300x250 = function() {
	this.spriteSheet = ss["CT12xx_Find_300x250_atlas_NP_"];
	this.gotoAndStop(0);
...
(lib.SUB = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("ApHD1IAAnpISQAAIAAHpg");
	mask.setTransform(226.5,130.6);

	// Layer 1
	this.instance = new lib.EndFrameblkfind300x250();
	...
	mask_1._off = true;
	mask_1.graphics.p("AqhBoIAAjPIVEAAIAADPg");
	mask_1.setTransform(208.5,242.5);

	// Layer 1
	this.instance_1 = new lib.EndFrameblkfind300x250();
...
(lib.CTA = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Ao+FEIAAqHIR8AAIAAKHg");
	mask.setTransform(223.5,194.5);
...
(lib.CT12xx_Find_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
